    ...
    (function (Forms) {
        var Booking = /** @class */ (function () {
            ...
            Booking.onload = function (executionContext) {
                ...
                flightAttribute.addOnChange(sf365.Forms.Booking.flightOnchange);
                var passengerGrid = formContext
                    .getControl("Passengers");
                passengerGrid.addOnLoad(function () { return Booking.passengerGridOnLoad(formContext); });
            };
            Booking.passengerGridOnLoad = function (formContext) {
            ...
            Booking.flightOnchange = function (executionContext) {
                var formContext = executionContext.getFormContext();
                var flightAttribute = formContext.data.entity.attributes
                    .get(sf365.sf365_booking._meta.attributes.sf365_flightid);
...
(function (sf365) {
    ...
    (function (Forms) {
        var Passenger = /** @class */ (function () {
            ...
            Passenger.flightOnchange = function (executionContext) {
        ...
        var PassengerGrid = /** @class */ (function () {
            ...
            PassengerGrid.onRecordSelect = function (executionContext) {
                ...
                var seatclassid = formContext.data.entity
                    ...
                    .get(sf365.sf365_passenger
                    ._meta.attributes.sf365_seatclassid);
                seatclassid.addOnChange(sf365.Forms.Passenger.flightOnchange);
            };
