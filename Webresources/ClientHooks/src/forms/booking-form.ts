...
namespace sf365.Forms {
    export class Booking {
        static onload(executionContext: Xrm.Page.EventContext) {
            ...
            passengerGrid.addOnLoad(() => Booking.passengerGridOnLoad(formContext));
        }

        static passengerGridOnLoad(formContext : Xrm.FormContext): any {
        ...
        static flightOnchange(executionContext: Xrm.Page.EventContext) {
            var formContext = executionContext.getFormContext();
